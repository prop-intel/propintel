...
```html
<img src="https://propintel.vercel.app/api/pixel/TRACKING_ID" alt="" style="position:absolute;width:0;height:0;border:0" />
```
...
fetch('https://propintel.vercel.app/api/middleware-track', {
  ...
  body: JSON.stringify({ trackingId, userAgent: ua, path: request.nextUrl.pathname, ip }),
});
```
