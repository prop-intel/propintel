...
type AdapterAccountType = "oauth" | "email" | "oidc" | "credentials";
...
export const accounts = createAuthTable(
  ...
  (d) => ({
    ...
    type: d.varchar("type", { length: 255 }).$type<AdapterAccountType>().notNull(),
...
export const authUser = users;
export const authAccount = accounts;
export const authSession = sessions;
export const authVerificationToken = verificationTokens;
