        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 backdrop-blur-sm text-sm font-medium mb-6 border border-white/20">
              ...
              <span>Ready for clear visibility?</span>
            </div>

            <h2 className="text-3xl md:text-5xl font-bold mb-6">Begin Your Optimization Journey</h2>
            <p className="text-primary-foreground/80 text-lg md:text-xl mb-8 max-w-2xl mx-auto">
              Get your first visibility report in minutes. See where you stand today, identify your next steps, and track your progress over time.
            </p>
